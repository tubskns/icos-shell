...
type ApiStartDeploymentByIdRequest struct {
	ctx context.Context
	ApiService *DeploymentAPIService
	deploymentId string
	apiKey *string
...
func (r ApiStartDeploymentByIdRequest) ApiKey(apiKey string) ApiStartDeploymentByIdRequest {
	r.apiKey = &apiKey
	return r
}

func (r ApiStartDeploymentByIdRequest) Execute() (map[string]interface{}, *http.Response, error) {
	return r.ApiService.StartDeploymentByIdExecute(r)
}
...
Starts a deployment
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param deploymentId ID of deployment to be resumed
 @return ApiStartDeploymentByIdRequest
*/
func (a *DeploymentAPIService) StartDeploymentById(ctx context.Context, deploymentId string) ApiStartDeploymentByIdRequest {
	return ApiStartDeploymentByIdRequest{
		ApiService: a,
		ctx: ctx,
		deploymentId: deploymentId,
...
func (a *DeploymentAPIService) StartDeploymentByIdExecute(r ApiStartDeploymentByIdRequest) (map[string]interface{}, *http.Response, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "DeploymentAPIService.StartDeploymentById")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/deployment/{deploymentId}/start"
	localVarPath = strings.Replace(localVarPath, "{"+"deploymentId"+"}", url.PathEscape(parameterValueToString(r.deploymentId, "deploymentId")), -1)
...
type ApiStopDeploymentByIdRequest struct {
	ctx context.Context
	ApiService *DeploymentAPIService
	deploymentId string
	apiKey *string
...
func (r ApiStopDeploymentByIdRequest) ApiKey(apiKey string) ApiStopDeploymentByIdRequest {
	r.apiKey = &apiKey
	return r
}

func (r ApiStopDeploymentByIdRequest) Execute() (map[string]interface{}, *http.Response, error) {
	return r.ApiService.StopDeploymentByIdExecute(r)
}
...
Stops a deployment
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param deploymentId ID of deployment that needs to be stopped
 @return ApiStopDeploymentByIdRequest
*/
func (a *DeploymentAPIService) StopDeploymentById(ctx context.Context, deploymentId string) ApiStopDeploymentByIdRequest {
	return ApiStopDeploymentByIdRequest{
		ApiService: a,
		ctx: ctx,
		deploymentId: deploymentId,
...
func (a *DeploymentAPIService) StopDeploymentByIdExecute(r ApiStopDeploymentByIdRequest) (map[string]interface{}, *http.Response, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "DeploymentAPIService.StopDeploymentById")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/deployment/{deploymentId}/stop"
	localVarPath = strings.Replace(localVarPath, "{"+"deploymentId"+"}", url.PathEscape(parameterValueToString(r.deploymentId, "deploymentId")), -1)
