...
func NewResourceAPIController(s ResourceAPIServicer, opts ...ResourceAPIOption) *ResourceAPIController {
...
func (c *ResourceAPIController) GetResourceById(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		c.errorHandler(w, r, &ParsingError{Param: "resourceId", Err: err}, nil)
		return
	}
